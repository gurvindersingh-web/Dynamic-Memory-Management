...
const LIGHT_THEMES = [
  ...
  },
  {
    ...
    colors: {
      ...
      '--text3': '#96897a',
      '--text4': '#bfb4a4',
      '--glass': 'rgba(250, 247, 242, 0.90)',
      '--glass-border': 'rgba(0, 0, 0, 0.06)',
      '--fifo': '#1864ab',
      '--fifo-dim': '#c5ddf0',
      '--fifo-glow': 'rgba(24, 100, 171, 0.12)',
      '--lru': '#7048a8',
      '--lru-dim': '#d8c8e8',
      '--lru-glow': 'rgba(112, 72, 168, 0.12)',
      '--opt': '#0e7c86',
      '--opt-dim': '#b8dce0',
      '--opt-glow': 'rgba(14, 124, 134, 0.12)',
      '--hit': '#2b8a3e',
      '--hit-dim': '#bce4c4',
      '--hit-glow': 'rgba(43, 138, 62, 0.12)',
      '--fault': '#c92a2a',
      '--fault-dim': '#f0bfc0',
      '--fault-glow': 'rgba(201, 42, 42, 0.12)',
      '--evict': '#e67700',
      '--evict-dim': '#f5d8a0',
      '--evict-glow': 'rgba(230, 119, 0, 0.12)',
      '--locality': '#c2255c',
      '--working': '#2b8a3e',
      '--thrash': '#c92a2a',
    },
    preview: 'linear-gradient(135deg, #faf7f2, #e8e2d8)',
  },
  {
    id: 'lavender',
    name: 'Lavender Mist',
